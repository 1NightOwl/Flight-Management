...
namespace FlightManagement.Migrations
{
    ...
    [Migration("20250529190436_Rregullimi_i_entitetit_te_biletave_dhe_user_per_bashkim")]
    partial class Rregullimi_i_entitetit_te_biletave_dhe_user_per_bashkim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightManagement.Core.Data.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlightManagement.Core.Data.Entities.Bileta", b =>
                {
                    b.HasOne("FlightManagement.Core.Data.Entities.Route", "Route")
                        .WithMany()
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlightManagement.Core.Data.Entities.User", "User")
                        .WithMany("Biletat")
